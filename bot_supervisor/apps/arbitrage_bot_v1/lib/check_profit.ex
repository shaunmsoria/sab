defmodule CheckProfit do
  ...
  def is_trade_profitable?(_price_difference, dex_name, token_pair_content, dex_name_searched, token_pair_searched) do
      with  router_address <- @dexs[dex_name]["router"]
            ...
            {:ok, simulated_profit_pre_gas, tradable_amount} <- simulate_profit_pre_gas(router_address, reserve0, reserve1, router_address_searched, reserve0_searched, reserve1_searched, token_pair_content, direction)
