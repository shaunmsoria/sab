  ...
  def handle_cast(:refresh_gas, state) do
    ...
    case gas_result do
      %{
        ...
        fast_gas_price_raw |> IO.inspect(label: "sx1 fast_gas_price_raw")
        max_gas_limit |> IO.inspect(label: "sx1 max_gas_limit")
        estimated_aggressive_max_gas_fee |> IO.inspect(label: "sx1 estimated_aggressive_max_gas_fee")
