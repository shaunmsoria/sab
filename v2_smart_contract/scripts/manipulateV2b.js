...
const UNLOCKED_ACCOUNT = '0x47ac0Fb4F2D84898e4D9E7b4DaB3C24507a6D503' // SHIB account to impersonate 
...
const AMOUNT = '10000' // 40,500,000,000,000 SHIB -- Tokens will automatically be converted to wei
...
async function main() {
  ...
  pair.on("Swap", async (...params) => {
    ...
    const data = {
      'Price Before': `1 WETH = ${Number(priceBefore).toFixed(0)} BANK`,
      'Price After': `1 WETH = ${Number(priceAfter).toFixed(0)} BANK`,
    }
